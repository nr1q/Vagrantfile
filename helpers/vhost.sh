...
Assumes /etc/apache2/sites-available and /etc/apache2/sites-enabled setup used
    ...
    Example Usage. Serve files from /var/www/nip.io at http(s)://192.168.33.10.nip.io
                   using ssl files from /etc/ssl/nip.io/nip.io.[key|crt]
    sudo vhost -d /var/www/nip.io -s 192.168.33.10.nip.io -p /etc/ssl/nip.io -c nip.io
_EOF_
exit 1
}
